...
public class AjouterJoueurToutesErreursKOMock implements IJoueurServices {
    ...
    public ReponseAjouterJoueurDTO ajouterJoueur(String prenom, String pseudo, int annee_naissance, String centre_interets, int langue) {
        ...
        liste_erreur.add(JoueurConstants.ERREUR_PSEUDO);
        liste_erreur.add(JoueurConstants.ERREUR_ANNEE_NAISSANCE);
        liste_erreur.add(JoueurConstants.ERREUR_CENTRE_INTERETS);
        liste_erreur.add(JoueurConstants.ERREUR_LANGUES);
